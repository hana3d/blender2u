...
BLENDERKIT2_LOCAL = "http://localhost:8001"
BLENDERKIT2_MAIN = "https://www.blenderkit.com"
BLENDERKIT2_DEVEL = "https://devel.blenderkit.com"
BLENDERKIT2_API = "/api/v1/"
BLENDERKIT2_REPORT_URL = "usage_report/"
BLENDERKIT2_USER_ASSETS = "/my-assets"
BLENDERKIT2_PLANS = "https://www.blenderkit.com/plans/pricing/"
BLENDERKIT2_MANUAL = "https://youtu.be/1hVgcQhIAo8"
BLENDERKIT2_MODEL_UPLOAD_INSTRUCTIONS_URL = "https://www.blenderkit.com/docs/upload/"
BLENDERKIT2_MATERIAL_UPLOAD_INSTRUCTIONS_URL = "https://www.blenderkit.com/docs/uploading-material/"
BLENDERKIT2_BRUSH_UPLOAD_INSTRUCTIONS_URL = "https://www.blenderkit.com/docs/uploading-brush/"
BLENDERKIT2_LOGIN_URL = "https://www.blenderkit.com/accounts/login"
BLENDERKIT2_OAUTH_LANDING_URL = "/oauth-landing/"
BLENDERKIT2_SIGNUP_URL = "https://www.blenderkit.com/accounts/register"
BLENDERKIT2_SETTINGS_FILENAME = os.path.join(_presets, "bkit.json")
...
def get_bkit_url():
    ...
    # d = 2
    if d == 1:
        url = BLENDERKIT2_LOCAL
    elif d == 2:
        url = BLENDERKIT2_DEVEL
    else:
        url = BLENDERKIT2_MAIN
    return url
...
def get_api_url():
    return get_bkit_url() + BLENDERKIT2_API


def get_oauth_landing_url():
    return get_bkit_url() + BLENDERKIT2_OAUTH_LANDING_URL


def default_global_dict():
    from os.path import expanduser
    home = expanduser("~")
    return home + os.sep + 'blenderkit2_data'
...
def delete_asset_debug(asset_data):
    from blenderkit2 import download
    user_preferences = bpy.context.preferences.addons['blenderkit2'].preferences
