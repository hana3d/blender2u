...
if "bpy" in locals():
    ...
    from blenderkit2 import ui, utils, paths, tasks_queue, bkit_oauth
        ...
        if rdata.get('detail') == 'Invalid token.':
            ...
            if user_preferences.api_key != '':
                if user_preferences.enable_oauth and user_preferences.api_key_refresh != '':
                    ...
                    'refreshing token. If this fails, please login in BlenderKit2 Login panel.', 10)))
                    ...
                    if auth_token is not None:
                        if immediate == True:
                            ...
                            bpy.context.preferences.addons['blenderkit2'].preferences.api_key = auth_token
                            bpy.context.preferences.addons['blenderkit2'].preferences.api_key_refresh = refresh_token
