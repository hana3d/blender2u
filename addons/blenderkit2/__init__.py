...
bl_info = {
    "name": "BlenderKit2 Asset Library",
    "author": "Vilem Duha, Petr Dlouhy",
    "version": (1, 0, 30),
    "blender": (2, 82, 0),
    "location": "View3D > Properties > BlenderKit2",
    "description": "Online BlenderKit2 library (materials, models, brushes and more)",
    "warning": "",
...
if "bpy" in locals():
    ...
    from blenderkit2 import asset_inspector, search, download, upload, ratings, autothumb, ui, icons, bg_blender, paths, \
        utils, \
...
# logging.basicConfig(filename = 'blenderkit2.log', level = logging.INFO,
...
def scene_load(context):
    ...
    ui_props = bpy.context.scene.blenderkit2UI
...
def get_upload_asset_type(self):
    typemapper = {
        BlenderKit2ModelUploadProps: 'model',
        BlenderKit2SceneUploadProps: 'scene',
        BlenderKit2MaterialUploadProps: 'material',
        BlenderKit2BrushUploadProps: 'brush'
    }
...
def asset_type_callback(self, context):
    ...
    if self.down_up == 'SEARCH':
        items = (
            ('MODEL', 'Find Models', 'Find models in the BlenderKit2 online database', 'OBJECT_DATAMODE', 0),
            # ('SCENE', 'SCENE', 'Browse scenes', 'SCENE_DATA', 1),
            ('MATERIAL', 'Find Materials', 'Find models in the BlenderKit2 online database', 'MATERIAL', 2),
            # ('TEXTURE', 'Texture', 'Browse textures', 'TEXTURE', 3),
            ('BRUSH', 'Find Brushes', 'Find models in the BlenderKit2 online database', 'BRUSH_DATA', 3)
        )
    else:
        items = (
            ('MODEL', 'Upload Model', 'Upload a model to BlenderKit2', 'OBJECT_DATAMODE', 0),
            # ('SCENE', 'SCENE', 'Browse scenes', 'SCENE_DATA', 1),
            ('MATERIAL', 'Uplaod Material', 'Upload a material to BlenderKit2', 'MATERIAL', 2),
            # ('TEXTURE', 'Texture', 'Browse textures', 'TEXTURE', 3),
            ('BRUSH', 'Upload Brush', 'Upload a brush to BlenderKit2', 'BRUSH_DATA', 3)
        )
    return items


class BlenderKit2UIProps(PropertyGroup):
    down_up: EnumProperty(
        ...
        description="BLenderKit2",
        default="SEARCH",
    )
    asset_type: EnumProperty(
        name="BlenderKit2 Active Asset Type",
...
class BlenderKit2CommonSearchProps(object):
    # STATES
...
def update_free(self, context):
    if self.is_free == False:
        self.is_free = True
        title = "All BlenderKit2 materials are free"
        message = "Any material uploaded to BlenderKit2 is free." \
...
class BlenderKit2CommonUploadProps(object):
    id: StringProperty(
...
class BlenderKit2RatingProps(PropertyGroup):
...
class BlenderKit2MaterialSearchProps(PropertyGroup, BlenderKit2CommonSearchProps):
...
class BlenderKit2MaterialUploadProps(PropertyGroup, BlenderKit2CommonUploadProps):
    style: EnumProperty(
        name="Style",
...
class BlenderKit2TextureUploadProps(PropertyGroup, BlenderKit2CommonUploadProps):
    style: EnumProperty(
        name="Style",
        items=material_styles,
...
class BlenderKit2BrushSearchProps(PropertyGroup, BlenderKit2CommonSearchProps):
    search_keywords: StringProperty(
        name="Search",
        description="Search for these keywords",
        default="",
...
class BlenderKit2BrushUploadProps(PropertyGroup, BlenderKit2CommonUploadProps):
    mode: EnumProperty(
        name="Mode",
        items=(
...
# upload properties
class BlenderKit2ModelUploadProps(PropertyGroup, BlenderKit2CommonUploadProps):
    style: EnumProperty(
        name="Style",
        items=model_styles,
        description="Style of asset",
...
class BlenderKit2SceneUploadProps(PropertyGroup, BlenderKit2CommonUploadProps):
    style: EnumProperty(
        name="Style",
        items=model_styles,
        description="Style of asset",
...
class BlenderKit2ModelSearchProps(PropertyGroup, BlenderKit2CommonSearchProps):
    search_keywords: StringProperty(
        name="Search",
        description="Search for these keywords",
        default="",
...
class BlenderKit2SceneSearchProps(PropertyGroup, BlenderKit2CommonSearchProps):
    search_keywords: StringProperty(
        name="Search",
        description="Search for these keywords",
        default="",
...
class BlenderKit2AddonPreferences(AddonPreferences):
    ...
    api_key: StringProperty(
        name="BlenderKit2 API Key",
        description="Your blenderkit2 API Key. Get it from your page on the website",
        default="",
        subtype="PASSWORD",
    ...
    api_key_refresh: StringProperty(
        name="BlenderKit2 refresh API Key",
    ...
    login_attempt: BoolProperty(
        ...
        description="When this is on, BlenderKit2 is trying to connect and login",
        default=False
    )
    ...
    search_in_header: BoolProperty(
        name="Show BlenderKit2 search in 3D view header",
        description="Show BlenderKit2 search in 3D view header",
        default=True
    )
...
classes = (
    ...
    BlenderKit2AddonPreferences,
    BlenderKit2UIProps,

    BlenderKit2ModelSearchProps,
    BlenderKit2ModelUploadProps,

    BlenderKit2SceneSearchProps,
    BlenderKit2SceneUploadProps,

    BlenderKit2MaterialUploadProps,
    BlenderKit2MaterialSearchProps,

    BlenderKit2TextureUploadProps,

    BlenderKit2BrushSearchProps,
    BlenderKit2BrushUploadProps,

    BlenderKit2RatingProps,
)
...
def register():
    ...
    bpy.types.Scene.blenderkit2UI = PointerProperty(
        type=BlenderKit2UIProps)

    # MODELS
    bpy.types.Scene.blenderkit2_models = PointerProperty(
        type=BlenderKit2ModelSearchProps)
    bpy.types.Object.blenderkit2 = PointerProperty(  # for uploads, not now...
        type=BlenderKit2ModelUploadProps)
    bpy.types.Object.bkit_ratings = PointerProperty(  # for uploads, not now...
        type=BlenderKit2RatingProps)

    # SCENES
    bpy.types.Scene.blenderkit2_scene = PointerProperty(
        type=BlenderKit2SceneSearchProps)
    bpy.types.Scene.blenderkit2 = PointerProperty(  # for uploads, not now...
        type=BlenderKit2SceneUploadProps)
    bpy.types.Scene.bkit_ratings = PointerProperty(  # for uploads, not now...
        type=BlenderKit2RatingProps)

    # MATERIALS
    bpy.types.Scene.blenderkit2_mat = PointerProperty(
        type=BlenderKit2MaterialSearchProps)
    bpy.types.Material.blenderkit2 = PointerProperty(  # for uploads, not now...
        type=BlenderKit2MaterialUploadProps)
    bpy.types.Material.bkit_ratings = PointerProperty(  # for uploads, not now...
        type=BlenderKit2RatingProps)

    # BRUSHES
    bpy.types.Scene.blenderkit2_brush = PointerProperty(
        type=BlenderKit2BrushSearchProps)
    bpy.types.Brush.blenderkit2 = PointerProperty(  # for uploads, not now...
        type=BlenderKit2BrushUploadProps)
...
def unregister():
    ...
    del bpy.types.Scene.blenderkit2_models
    del bpy.types.Scene.blenderkit2_scene
    del bpy.types.Scene.blenderkit2_brush
    del bpy.types.Scene.blenderkit2_mat

    del bpy.types.Scene.blenderkit2
    del bpy.types.Object.blenderkit2
    del bpy.types.Material.blenderkit2
    del bpy.types.Brush.blenderkit2
