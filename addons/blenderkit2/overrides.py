...
class BringToScene(Operator):
    ...
    bl_idname = "object.blenderkit2_bring_to_scene"
    bl_label = "BlenderKit2 bring objects to scene"
...
class ModelProxy(Operator):
    ...
    bl_idname = "object.blenderkit2_make_proxy"
    bl_label = "BlenderKit2 Make Proxy"
...
class ColorCorrector(Operator):
    ...
    bl_idname = "object.blenderkit2_color_corrector"
